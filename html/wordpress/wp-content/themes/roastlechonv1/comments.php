				...
				<?php if ( $comments ) : ?>
			<div id="comments">
			<h1>Comments <?php comments_rss_link(__('RSS')); ?></h1>
				<ol>
				...
				<?php endif; ?>
				<?php if ( pings_open() ) : ?>
				<a class="trackback" href="<?php trackback_url() ?>" rel="trackback"><?php _e('TrackBack <abbr title="Uniform Resource Identifier">URI</abbr>'); ?></a>
				<?php endif; ?>
