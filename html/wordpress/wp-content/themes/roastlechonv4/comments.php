				...
				<?php return; endif; ?>
				<?php if ( $comments ) : ?>
				<h2 class="responses-title">Responses to "<?php the_title(); ?>"</h2>
					<ol class="responses-list">
					<?php foreach ($comments as $comment) : ?>
						<li>
						<?php comment_author_link() ?> says...<?php edit_comment_link(__("Edit This")); ?>
						<?php comment_text() ?>
						</li>
					<?php endforeach; ?>
					</ol>
				...
				<h2 class="post-response"><?php _e('Leave a response'); ?></h2>
